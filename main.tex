...
\include{template}  % THIS is the line that includes the FU template!
...
\titleimage{images/capa}

\title[Técnicas de suavização] % (optional, use only with long paper titles)
{Smoothing Techniques}

\subtitle
{Applied to seismic sources characterization and \\ probabilistic seismic hazard analysis (PSHA)}
