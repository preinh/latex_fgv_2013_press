...
\usepackage[font=small,compatibility=false]{subcaption}
\usepackage[caption=false]{subfig}

\captionsetup[subcaption]{}
...
\begin{figure}
	\centering
	\subfloat[Número de tremores registrados por ano,\gls*{iscgem}.
			\label{fig:sa_eq_record}]{
		  	\centering
			\includegraphics[width=0.48\textwidth]{images/hmtk_sa3_rate}}
	\quad %~ %add desired spacing between images, e. g. ~, \quad, \qquad, \hfill etc.
	\subfloat[Número de tremores registrados por ano,\gls*{bsb2013}
			\label{fig:br_eq_record}]{
		  	\centering
			\includegraphics[width=0.48\textwidth]{images/hmtk_bsb2013_rate}}
	\caption{Número de tremores registrados por ano após 1900}
	\label{fig:eq_record}
\end{figure}
\end{frame}
